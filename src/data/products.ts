...
export const products: Product[] = [
  ...
  // === BRUSH PENS (SETS) ===
  { id: "37", name: "Tombow Dual Brush Pen Set - 10 colours", price: 31.50, originalPrice: 38.00, images: [imgTombowDual10], category: "Pens & Markers", tags: ["brush-pen", "lettering", "dual-tip"], description: "10 dual-tip brush pens with flexible brush tip and fine tip. Water-based ink blends beautifully. Ideal for hand lettering, calligraphy, and watercolour-style illustrations.", isCommunityFavourite: true, purchaseCount: 1876, reviewCount: 456, rating: 4.7, creativePath: "lettering", hasStartSmall: true, startSmallPrice: 15.90, pairsWellWith: ["23", "26"], colors: ["multicolor"], inStock: true },
  ...
  { id: "42", name: "Staples Heavy-Duty Stapler", price: 14.90, images: [imgStapler], category: "Office Supplies", tags: ["stapler", "office", "heavy-duty"], description: "Full-strip stapler that handles up to 40 sheets. Durable all-metal construction with soft-grip handle. Non-skid rubber base. Uses standard 26/6 and 24/6 staples.", isCommunityFavourite: false, purchaseCount: 345, reviewCount: 67, rating: 4.0, pairsWellWith: ["41"], colors: ["grey", "black"], inStock: true },
  { id: "43", name: "Muji Desk Organiser - 3 compartments", price: 15.80, images: [imgDeskOrg], category: "Office Supplies", tags: ["organiser", "desk", "muji", "storage"], description: "Clear acrylic desk organiser with 3 compartments for pens, pencils, and accessories. Minimalist Muji design keeps your workspace tidy. Durable and easy to clean.", isCommunityFavourite: true, purchaseCount: 1123, reviewCount: 289, rating: 4.6, pairsWellWith: ["4", "11"], colors: ["white", "grey"], inStock: true },
