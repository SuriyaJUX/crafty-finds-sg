            ...
            return (
              ...
              >
                ...
                <div className="aspect-square w-full overflow-hidden relative">
                  ...
                  {discountPercent > 0 && (
                    <span className="absolute top-1 right-1 md:group-hover:top-2 md:group-hover:left-2 md:group-hover:right-auto bg-deals-banner text-deals-banner-foreground text-[10px] md:group-hover:text-[11px] font-bold px-1.5 md:group-hover:px-2 py-0.5 rounded-md md:group-hover:rounded-full leading-none transition-all duration-[400ms] z-10">
                      -{discountPercent}%
                    </span>
                  )}
